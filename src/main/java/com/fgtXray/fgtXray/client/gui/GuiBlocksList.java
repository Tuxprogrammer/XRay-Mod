...
public class GuiBlocksList extends GuiScrollingList {
    ...
    GuiBlocksList(GuiBlocks parent, List<HelperBlock> blockList) {
        super(parent.getMinecraftInstance(), 200, 210, parent.height / 2 - 105, parent.height / 2 + 80,
                parent.width / 2 - 97, HEIGHT);
    ...
    protected void drawSlot(int idx, int right, int top, int height, Tessellator tess) {
        ...
        if (block.getItemStack() != null) {
            ...
            this.parent.getRender().renderItemAndEffectIntoGUI(null, null, block.getItemStack(), this.left + 5,
                    top + 7);
