...
public class GuiEditOre extends GuiContainer {
        ...
        if (stack != null) {
            if (!ItemStackHelper.isEmpty(stack))
                this.selectBlock = new HelperBlock(
                        stack.getDisplayName(), Block.getBlockFromItem(stack.getItem()), stack, stack.getItem(),
    ...
    public void drawScreen(int x, int y, float f) {
        ...
        this.itemRender.renderItemAndEffectIntoGUI(null, null, selectBlock.getItemStack(), width / 2 + 88,
                height / 2 - 105);
